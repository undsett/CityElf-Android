...
public class Constants {
  ...
  public class WebUrls {
    ...
    public static final String GET_ALL_POOLS = "http://test:8088/services/polls/getAll?addressid=";
    ...
    public static final String FORGOT_PASSWORD_URL = "http://test:8088/services/forgot/reset?email=";
    public static final String UPDATE_USER_URL = "http://test:8088/services/users/updateuser";
    public static final String USER_REPORT_SHUTDOWN = "http://test:8088/services/peoplereport/add";
    ...
    public static final String GET_USERDATA_URL = "http://test:8088/services/users/";
  }
