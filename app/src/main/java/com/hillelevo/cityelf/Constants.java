...
public class Constants {
  ...
  public class WebUrls {
    ...
    public static final String GET_ALL_FORECASTS = "http://:8088/services/allforecasts/get?address=";
    public static final String GET_ALL_ADVERTS = "http://:8088/services/advertisements/getall?addressid=";
    public static final String GET_ALL_POOLS = "http://:8088/services/polls/getall?addressid=";
    public static final String ADD_NEW_USER = "http://:8088/services/registration/adduser";
    public static final String AUTHORIZATION_URL = "http://:8088/services/registration/login";
    public static final String REGISTRATION_URL = "http://:8088/services/registration/register";
    public static final String FORGOT_PASSWORD_URL = "http://:8088/services/forgot/reset?email=";
    public static final String UPDATE_USER_URL = "http://:8088/services/users/updateuser";
    public static final String USER_REPORT_SHUTDOWN = "http://:8088/services/peoplereport/add";
    ...
    public static final String GET_USERDATA_URL = "http://:8088/services/users/";
    public static final String ADD_NEW_ADVERTS_URL = "http://:8088/services/advertisements/admin/addadvertisement";
    public static final String ADD_NEW_POLLS_URL = "http://:8088/services/polls/admin/addpoll";
  }
