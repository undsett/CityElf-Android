...
public class PollListAdapter extends ArrayAdapter<Poll> implements OnClickListener,
  ...
  TextView peopleCount = null;
  Button vote = null;
  RadioGroup radioGroup = null;
  RadioButton rButtonOne = null;
  RadioButton rButtonTwo = null;
  RadioButton rButtonThree = null;
  RadioButton rButtonFour = null;
  ...
  public View getView(int position, View convertView, @NonNull ViewGroup parent) {
    ...
    if (poll != null) {
      title = (TextView) view.findViewById(R.id.tvPollTitle);
      address = (TextView) view.findViewById(R.id.tvPollAddress);
      duration = (TextView) view.findViewById(R.id.tvPollDuration);
      time = (TextView) view.findViewById(R.id.tvPollTime);
      content = (TextView) view.findViewById(R.id.tvPollContent);
      peopleCount = (TextView) view.findViewById(R.id.tvPollPeopleCount);
      vote = (Button) view.findViewById(R.id.btnPollVote);
      radioGroup = (RadioGroup) view.findViewById(R.id.rgPoll);
      rButtonOne = (RadioButton) view.findViewById(R.id.rbPoll1);
      rButtonTwo = (RadioButton) view.findViewById(R.id.rbPoll2);
      rButtonThree = (RadioButton) view.findViewById(R.id.rbPoll3);
      rButtonFour = (RadioButton) view.findViewById(R.id.rbPoll4);
...
//    new PollsTask(this).execute(WebUrls.NEW_VOICE_URL, Constants.POST, );
