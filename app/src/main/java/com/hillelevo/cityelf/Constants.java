...
public class Constants {
  ...
  public class WebUrls {
    public static final String GET_ALL_FORECASTS = "hosr:8088/services/allforecasts/get?address=";
    public static final String GET_ALL_ADVERTS = "http://host:8088/services/advertisements/getAll?addressid=";
    public static final String GET_ALL_POOLS = "http://host:8088/services/polls/getPoll?id=";
